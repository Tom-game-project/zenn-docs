...
sedには、加減乗除、剰余はもちろん、関数や変数などもありません。
その代わりに、ジャンプラベル、Hold/Patternスペースのような特徴的な概念があります。sedで計算らしいことをするためにはまずこれらの概念を多少理解する必要があるでしょう。
...
直感的に扱いやすいと感じたため数値のデータは二進数で管理しています。
...
sedを埋め込める必要があるので、それを意識しつつ実装していきます。
